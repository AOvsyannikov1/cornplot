...
def show_demo_animation(dark=False):
    ...
    plt.subplot(2, 1, 1)
    plt.animated_plot("Sin", x_size=10, limit_data=False)
    plt.animated_plot("Cos", x_size=10, limit_data=False)
    plt.subplot(2, 1, 2)
    plt.animated_plot("SinSin", x_size=10, limit_data=False)
    plt.animated_plot("CosCos", x_size=10, limit_data=False)
